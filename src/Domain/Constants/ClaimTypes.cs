...
public struct ClaimTypes
{
    ...
    public const string ConnectionId = "http://userswithoutidentity/claims/connectionId";
    public const string PackageId = "http://userswithoutidentity/claims/packageId";
}