...
//    {
//        var result = await SchoolService.GetSchoolById(id);
//        return Ok(result);
//    }
...
//    {
//        var result = await SchoolService.GetSchoolByTaxNumber(taxNumber);
//        return Ok(result);
//    }
...
//    {
//        var result = await SchoolService.GetSchoolForDashboard();
//        return Ok(result);
//    }

//    [HttpGet("GetSchools")]
//    public async Task<IActionResult> GetSchools([FromQuery] PageRequestModel model)
//    {
//        var result = await SchoolService.GetSchools(model);
//        return Ok(result);
//    }
