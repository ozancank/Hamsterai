...
public class PackageConfiguration : IEntityTypeConfiguration<Package>
{
    public void Configure(EntityTypeBuilder<Package> builder)
    {
        ...
        builder.HasAlternateKey(e => e.Name).HasName("UK_Packages_Name");
        ...
        builder.Property(e => e.Price).HasColumnName("Price").HasDefaultValue(0).HasColumnOrder(9).IsRequired();
        builder.Property(e => e.OldPrice).HasColumnName("OldPrice").HasColumnOrder(10);
